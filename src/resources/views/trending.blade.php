...
<div class="container mt-4">
    ...
    @if(empty($trending_predictions))
        <div class="prediction-card text-center" style="padding: 3rem;">
            ...
            <h4 style="margin-bottom: 0.5rem;">No Trending Predictions Yet</h4>
            <p class="text-muted">Be the first to create a prediction and start trending!</p>
            <a href="{{ route('predictions.create') }}" class="btn btn-primary mt-2">
                <i class="bi bi-plus-circle me-2"></i>Create Prediction
            </a>
        </div>
    @else
